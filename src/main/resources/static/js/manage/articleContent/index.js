...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_departments').bootstrapTable({
            url: $ctx+'/manage/articleContent/list',         //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
            ...
            ,{
                field:'htmlOption',
                title:'操作',
                formatter:'optionFormater',
                cellStyle:'htmlOptionCellStyle',
            }]/*,
            onDblClickRow:function(row){
                ajaxGetCommon("manage/articleContent/edit?id="+row.id,changeFrameContent);
            }*/
        });
    };
